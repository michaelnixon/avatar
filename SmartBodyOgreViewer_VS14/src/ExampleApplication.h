...
protected:
	...
	virtual bool setup(void)
	{
		...
		std::cerr << "####LOADING COMPOSITOR: " << CompositorManager::getSingleton().addCompositor(mWindow->getViewport(0), "Noise in the Channel") << std::endl << std::endl;
		CompositorManager::getSingleton().setCompositorEnabled(mWindow->getViewport(0), "Noise in the Channel", true);

		//		std::cerr << "####LOADING COMPOSITOR: " << CompositorManager::getSingleton().addCompositor(mWindow->getViewport(0), "Night Vision") << std::endl  << std::endl;
		//		CompositorManager::getSingleton().setCompositorEnabled(mWindow->getViewport(0), "Night Vision", true);
	...
	virtual void createCamera(void)
	{
		...
		mCamera->setFOVy(Ogre::Degree(20));
	...
	virtual void setupResources(void)
	{
		...
		if (boost::filesystem::exists(mResourcePath + "resources.cfg")) {
		...
		strHomePath.append("/");
#endif
		if (boost::filesystem::exists(strHomePath + "resources.cfg")) {
