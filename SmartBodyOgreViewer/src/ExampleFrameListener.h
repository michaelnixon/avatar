...
protected:
	virtual void updateStats(void) {
		//std::cout << "ExampleFrameListener::updateStats(void)" << std::endl;
...
public:
		...
		mInputManager(0), mMouse(0), mKeyboard(0), mJoy(0)
	{
		...
		/*Ulysses: for this to work you must load OgreCore.zig (!!!) */		 
	...
	virtual void showDebugOverlay(bool show) {
		//	std::cout << "showDebugOverlay(bool show): " << show << std::endl;
		if (mDebugOverlay) {
			if (show) {
				mDebugOverlay->show();
			} else {
